...
const CustomFilter = ({title,options}:optionProps) => {
const [selected,setSelected]=useState(options[0])
const router = useRouter()


const handleUpdateParams = (e:{title: string, value:string})=>{
  const newPathname = updateSearch(title,e.value.toLowerCase());
    ...
    <div className='w-fit'>
      ...
      >
        <div className='relative w-fit z-10'>
          ...
          <Image src="/chevron-up-down.svg" alt="up and down" height={20} width={20}/>
